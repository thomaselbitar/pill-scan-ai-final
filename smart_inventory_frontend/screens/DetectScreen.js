...
export default function DetectScreen() {
  ...
  const handleDetect = () => {
    ...
    setIsScanning(true);
    console.log("Detecting with this image:", image);
    // TODO: Call your detection API here.
    // When the API response comes back, call:
    // setIsScanning(false);
    // and show your third content state.
  };
      ...
      <View
        ...
        <View style={styles.headerRow}>
          <View
            ...
            <Ionicons name={isScanning ? 'scan-outline' : 'add-circle'} size={26} color={currentColors.primary} />
          </View>
        ...
        {!image && !isScanning && (
          <View style={styles.actionsColumn}>
            ...
            <TouchableOpacity
              ...
              onPress={takePhoto}>
              <Ionicons name="camera-outline" size={20} color={currentColors.primary} style={styles.buttonIcon} />
